...
public class AlertsActivity extends AppCompatActivity {
    ...
    public void button3_clicked (View button) {
        ...
        builder.setSingleChoiceItems(R.array.animal, selectedAnimalIndex, null);
        builder.setPositiveButton(R.string.confirm, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int index) {
                ...
                switch (selectedAnimalIndex) {
                    case 0: drawbleId = R.mipmap.animal_cat_large; break;
                    case 1: drawbleId = R.mipmap.animal_dog_large; break;
                    case 2: drawbleId = R.mipmap.animal_owl_large; break;
                }
    ...
    public void button4_clicked (View button) {
        ...
        builder.setPositiveButton(R.string.cat, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int index) {
                ImageView imageView1 = (ImageView)findViewById(R.id.imageView1);
                imageView1.setImageResource(R.mipmap.animal_cat_large);
            }
        });
        builder.setNeutralButton(R.string.dog, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int index) {
                ImageView imageView1 = (ImageView)findViewById(R.id.imageView1);
                imageView1.setImageResource(R.mipmap.animal_dog_large);
            }
        });
        builder.setNegativeButton(R.string.owl, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int index) {
                ImageView imageView1 = (ImageView)findViewById(R.id.imageView1);
                imageView1.setImageResource(R.mipmap.animal_owl_large);
            }
        });
        AlertDialog dialog = builder.create();
        dialog.show();
