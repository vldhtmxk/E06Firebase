    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioGroup.OnCheckedChangeListener listener3 = new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                int drawbleId =0;
                switch (checkedId) {
                    case R.id.radioRed: drawbleId = R.mipmap.animal_cat_large;break;
                    case R.id.radioDog : drawbleId = R.mipmap.animal_dog_large;break;
                    case R.id.radioOwl : drawbleId = R.mipmap.animal_owl_large;break;
                }
